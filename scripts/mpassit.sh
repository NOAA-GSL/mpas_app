...
while getopts "m:w:f:i:x:p:e:s:vh" opt; do
  case ${opt} in
    m )
      MODULE_FILE=$OPTARG
      ;;
...
parmfiles=(diaglist histlist_2d histlist_3d.NSSL histlist_soil)
...
cp $PARM_DIR/namelist.mpassit $nmlfile
